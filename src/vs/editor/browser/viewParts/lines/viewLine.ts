...
export class ViewLine implements IVisibleLineData {
	...
	private _renderHardSpace: boolean;
	...
	constructor(context:ViewContext) {
		...
		this._renderHardSpace = this._context.configuration.editor.viewInfo.renderHardSpace;
